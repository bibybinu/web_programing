                ...
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input class="sub1" type="submit" value="Add" name="add" style="background-color: #337ab7;">
                        </th>
                    </tr>
                </table>
            </form>
                ...
                <tr>
                    <th colspan="10">
                        <form name="sform">
                            ...
                            <input class="sub2" type="button" value="Search" name="search" style="background-color: #337ab7;" onclick="window.location.replace('prog16.php?search='+document.sform.key.value)">
                        </form>
                    </th>
                </tr>
                <?php
